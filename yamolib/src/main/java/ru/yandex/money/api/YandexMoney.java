...
public interface YandexMoney {
     ...
     */
    public static String URI_YM_AUTH_MOBILE =
     ...
     */
    public static String URI_YM_TOKEN_MOBILE =
     ...
     * @param mobile      флаг выбора странички авторизации (мобильный сайт для true и обычный для false)
     ...
     * @return экземпляр класса {@link AccountInfoResponse}
     * @throws java.io.IOException        ошибка связи с сервером Яндекс.Денег
     * @throws InsufficientScopeException запрошена операция, на которую у
     *                                    токена нет прав.
